...
from psm.domain.models import Guard, Lexeme, Observation, Tombstone
from psm.engine.projector import merge_variant
from psm.engine.text import changed_segments
...
def observation(
    ...
    *,
    ...
    from psm.domain.models import GLOBAL
