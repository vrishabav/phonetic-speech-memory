...
The word list is a data file (`src/psm/data/common_words.txt`), which is the
...
from psm.domain.enums import GuardKind, VariantProvenance
from psm.domain.models import Guard, Lexeme
