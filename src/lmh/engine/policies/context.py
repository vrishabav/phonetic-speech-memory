...
from lmh.domain.enums import BindingScope, GuardKind, LexemeKind, ReasonCode
from lmh.domain.models import Candidate, Guard
from lmh.engine.guards import DEFAULT_SUPPORT, is_common
from lmh.engine.text import window_tokens
