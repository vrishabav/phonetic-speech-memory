...
from lmh.adapters.formatter.passthrough import PassthroughFormatter
from lmh.adapters.index.inmemory import InMemoryIndex
from lmh.adapters.phonetics.dmetaphone import PhoneticStack
from lmh.config import Settings
from lmh.domain.enums import LexemeState, ObservationSource, Verdict
from lmh.domain.models import Adjudication, Cost, Lexeme, Observation, Resolution, Utterance
from lmh.engine.adjudicator import Adjudicator
from lmh.engine.applier import apply_resolutions
from lmh.engine.guards import synthesise_all
...
from lmh.ports.policy import PolicyContext
...
class Engine:
    ...
    def snapshot(self):
        from lmh.domain.models import MemorySnapshot
